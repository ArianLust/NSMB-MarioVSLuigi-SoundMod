...
public class Settings : Singleton<Settings> {
    ...
    public bool scoreboardAlways = true, filter = true, musicRand = true;
    ...
    public void LoadSettingsFromPreferences() {        
        ...
        musicRand = PlayerPrefs.GetInt("MusicRandomize", 1) == 1;
    ...
    public void SaveSettingsToPreferences() {
        ...
        PlayerPrefs.SetInt("MusicRandomize", musicRand ? 1 : 0);
